...
```
    ...
    FILE
        c:\anaconda36\lib\site-packages\cv2.cp36-win_amd64.pyd
...
```
    ...
    'I:\\GITHUB\\GH_AaronCHH\\B_PYTHON\\實用Python程式設計\\SF_PP'
...
```
    ...
    'I:\\GITHUB\\GH_AaronCHH\\B_PYTHON\\實用Python程式設計\\SF_PP\\Python-Data-Sets'
